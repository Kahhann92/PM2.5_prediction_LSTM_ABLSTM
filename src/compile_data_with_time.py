...
print("Read complete, file wrote to dataset/full_data_with_time.csv")

print("Processing data to supervised sequence data")
# write to main file
df.to_csv('dataset/full_data_with_time.csv', header = True)
...
# write file
processedData.to_csv('dataset/processed_data_with_time.csv', header = True)
