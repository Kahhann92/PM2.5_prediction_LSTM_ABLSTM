...
from seq2seq_attention_2 import seq2seq_attention
...
model = seq2seq_attention(n_features, n_outputs, input_shape, n_timesteps)
...
# Show graphic
# plt.show()
plt.savefig('figures/accuracy_attention.png')
...
plt.legend()
plt.savefig('figures/loss_attention.png')
...
with open("model/ABLSTM.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("model/ABLSTM.h5")
